...
function filename(target) {
  switch (target.toLowerCase()) {
    ...
    case 'pacman':   return `${pkgName}-${version}.pacman`;
    default:         return null;
  }
}
...
const META = {
  ...
  pacman:   { title: 'Arch Linux / Manjaro',   desc: 'Native .pacman package for Arch Linux and derivatives.',      btn: 'Download .pacman'  },
};
